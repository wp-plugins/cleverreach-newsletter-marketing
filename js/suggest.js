...
document.getElementById("list_div").innerHTML= '<div style="width:600px; maring-top:40px"><center><br /><br /><img src="http://'+domain+'/wp-content/plugins/cleverreach-newsletter-marketing/images/loading.gif" /><br /><br />Einen Moment bitte, Daten werden geladen!</center></div>';
  ...
  with (new Ajax()){
    ...
    url="http://"+domain+"/wp-content/plugins/cleverreach-newsletter-marketing/getForms.php";
    method="GET";
